      ...
      <section className={styles.video_sec}>
        ...
        <div className="container">
          <div className={styles.banner_desc}>
            <h6>Welcome to Preach Concepts LLC</h6>
            <h1>Your Partner in <span style={{ color: "#005AAB" }}> SaaS </span>
             Product Management and Software Development</h1>
            <p>At Preach Concepts LLC, we turn innovative ideas into successful, scalable products, ensuring market fit and top-notch development for competitive success.</p>
